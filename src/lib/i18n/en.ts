...
export const en = {
  ...
  settings: {
    ...
    tabBackend: 'Backend',
    tabAbout: 'About',
    usagePlaceholder: 'Token usage stats will be available in a future release.',
    backendPlaceholder: 'Agent backend selection (omp / pi) will be available in a future release.',
