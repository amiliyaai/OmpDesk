...
export const ja = {
  ...
  settings: {
    ...
    noKey: 'Key なし',
    mcpServers: 'MCP サーバー',
    mcpHint: 'ユーザー設定は ~/.omp/agent/mcp.json に書き込み(書込前にバックアップ);プロジェクト・互換ソースは読み取り専用。Claude Code / Codex / Cursor 等のツール設定からも読み取り表示。変更後セッションの再起動が必要です。',
    mcpSource: 'ソース: {source}',
    deleteMcpTitle: 'MCP サーバーを削除',
    deleteMcpMsg: 'MCP サーバー「{name}」を削除しますか?',
    addServer: 'サーバーを追加',
    skillsTitle: 'Skills (~/.omp/skills、~/.agents/skills 等, SKILL.md 検出)',
    skillsHint: 'オフ = config.yml の skills.ignoredSkills に書き込み。',
    noDescription: '(説明なし)',
    noSkills: 'Skills が見つかりません。',
    skillRootUser: 'ユーザー',
    skillRootProject: 'プロジェクト',
    skillRootManaged: 'managed',
    skillRootPlugins: 'プラグイン',
    theme: 'テーマ',
    themeSystem: 'システムに従う',
    themeDark: 'ダーク',
    themeLight: 'ライト',
