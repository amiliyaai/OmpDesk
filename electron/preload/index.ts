...
const api: OmpApi = {
  ...
  isGitRepo: (workspace: string) => ipcRenderer.invoke('omp:isGitRepo', workspace),
  getWorktrees: (workspace: string) => ipcRenderer.invoke('omp:getWorktrees', workspace),
  addWorktree: (workspace: string, branch?: string) => ipcRenderer.invoke('omp:addWorktree', workspace, branch),
  removeWorktree: (workspace: string, wtPath: string) => ipcRenderer.invoke('omp:removeWorktree', workspace, wtPath),
